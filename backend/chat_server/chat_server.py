...
async def general_message(message:str, user:User):
...
async def private_message(myid:int, channel:str, message:str, user:User):
    try:
...
async def handle_client(websocket, path):
    ...
    try:
        ...
        async for data in websocket:
            ...
            if channel == "general":
                await general_message(message, user)
                continue
            await private_message(myid, channel, message, user)
